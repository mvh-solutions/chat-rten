    ...
    loop {
        ...
        let token_ids = encode_message(
            ...
            &[
                ...
                MessageChunk::Text("First we have different English translations of the same verse. Pay attention to the names of the translations, and to the differences between the translations for this verse.\n\n"),
                MessageChunk::Text(translation_context.as_str()),
                MessageChunk::Text("Then we have notes on the verse as a whole.\n\n"),
                MessageChunk::Text(note_context.as_str()),
                MessageChunk::Text("Finally we have notes on important words in this verse.\n\n"),
